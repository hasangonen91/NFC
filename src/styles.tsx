...
export const styles = StyleSheet.create({
  ...
  dataValueMultiline: {
    ...
    textAlign: 'center', // Metni sola yasla
    flex: 1, // Text'in container içinde yayılmasını sağlar
  },
  ...
  dataValueRaw: {
    ...
    borderRadius: 6, // Kenarlar yuvarlatılabilir
    padding: 10, // İçerikten boşluk
    marginTop: 5, // Üstten boşluk
    marginBottom: 10, // Altta boşluk
  },
  copyContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
    marginTop: 10, // Altta boşluk
    marginBottom: 20, // Altta boşluk daha fazla
  },
  copyIcon: {
    marginLeft: 10,
